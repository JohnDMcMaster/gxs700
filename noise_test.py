...
class NoiseTest(object):
    ...
    def run(self):
        ...
        while True:
            ...
            last = bufavg(buff)
            print 'twait % 10.3f, tint % 10.3f, %10.3f' % (self.wait_t, self.int_t, last)
            self.wait_t *= 2
            self.int_t *= 2

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Report average pixel noise for various integration/wait times')
